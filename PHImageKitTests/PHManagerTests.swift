...
//
//        stubRequest("GET", urlPath as LSMatcheable!).andReturn(200)?.withBody(ik_imageData())
//
//        ik_expectation(description: "Mager  expectation") { (expectation) -> Void in
...
//        let url = URL(string: urlPath)!
//
//        stubRequest("GET", urlPath as LSMatcheable!).andReturn(200)?.withBody(ik_gifData())
//
